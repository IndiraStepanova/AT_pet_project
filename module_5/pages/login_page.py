...
class LoginPage(BasePage):
    ...
    def should_be_login_form(self):
        ...
        assert self.element_to_be_clickable(*LoginPageLocators.LOGIN_SUBMIT_BUTTON), "Submit button is not clicable!" """
    ...
    def should_be_register_form(self):
        ...
        assert self.EC.element_to_be_clickable(*LoginPageLocators.REGISTER_USERNAME_FIELD), "Submit button is not clicable!" """